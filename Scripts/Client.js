...
$('body').on('click', '.btnRefillBalance', function () {
    ...
    var clientName = $(container).find('div:first').next('div').find('text').text();
    ...
    $.ajax({
        ...
        data: { clientCode: clientCode, clientName: clientName, currentBalance: currentBalance, newBalance: updatedBalance, refillAmount: refillBalance, remarks: remarks },
        success: function (data) {
            $('.modal-content').html('');
            $('.modal-content').append(data);
        }
...
$('body').on('click', '.btnCancelRefill', function () {
    ...
    $.ajax({
        type: "GET",
        url: "/Client/_RefillBalance",
        data: { clientCode: clientCode, clientName: clientName, balance: currentBalance, newBalance: newBalance, refillAmount: refillAmount, remarks: remarks },
        success: function (data) {
            $('.modal-content').html('');
            $('.modal-content').append(data);
...
$('body').on('click', '.btnConfirmRefill', function () {
    ...
    $.ajax({
        ...
        data: { clientCode: clientCode, refillAmount: refillAmount, remarks: remarks },
        success: function (data) {
...
$('body').on('keypress', '.txt-edit-refill', function (e) {
    ...
    if (e.keyCode == 13 || e.keyCode == 9) {
        ...
        $.ajax({
            ...
            data: { refillId: refillId, remarks: remarks },
            success: function (data) {
